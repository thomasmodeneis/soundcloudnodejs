 ...
 * @returns {*}
 */
var addTrack = function addTrack(options, cb) {
 ...
 * @returns {*}
 */
var addTrackToPlaylist = function addTrackToPlaylist(options, cb) {
 ...
 * @returns {*}
 */
var addTrackToNewPlaylist = function addTrackToNewPlaylist(options, cb) {
